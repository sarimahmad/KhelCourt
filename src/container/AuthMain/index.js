    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={[styles.container, {alignItems: 'center'}]}>
        ...
        <Text style={styles.welcomeText}>
          Welcome to KhelCourt your all in one Solution to everyday Sports
          Activities
        </Text>
        <Text style={[styles.fontSize16, styles.marginTop]}>
          Explore{' '}
          <Feather name="arrow-right" size={16} color={constant.primaryColor} />
        </Text>
        <Text style={[styles.font14, {marginTop: 71}]}>Continue As</Text>
        ...
        <Text
          style={[
            styles.fontSize16,
            {marginTop: constant.margin50, fontFamily: constant.interBold},
          ]}>
          Don’t have an account?
          <Text
            onPress={() => props.navigation.navigate('SignUp')}
            style={{color: constant.primaryColor}}>
            {' '}
            Sign Up
          </Text>
        </Text>
